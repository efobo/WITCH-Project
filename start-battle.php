                            ...
                            if ($count > 0)
                            {
                                while ($row = mysqli_fetch_assoc($res))
                                {
                                    ...
                                    if ($count2 == 1)
                                    {
                                        ...
                                        $sql14 = "SELECT * FROM universe WHERE id=$id_universe";
                                    ...
                                    ?>
                                        <option value=<?php echo $id_location; ?>>
                                        <?php if ($location == "unknown") echo $location; else echo $location.'('.$universe.')';?>
                                        </option>
                                    <?php
                                }
                            }
            ...
            if (isset($_POST['submit']))
            {
                ...
                if ($qty_soldiers < 0) 
                {
                    $_SESSION['msg'] = "<div class='error'>You can't send less then 0 soldiers into battle</div>";
                        header('location:'.SITEURL.'start-battle.php');
                }
               ...
               header('location:'.SITEURL.'manage-wars.php');
