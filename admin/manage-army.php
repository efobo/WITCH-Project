...
<div class="main-content">
    <div class="wrapper">
        ...
        <!-- Button to Add Army -->
        <a href="<?php echo SITEURL; ?>admin/add-army.php" class="btn-primary">Add Someone</a>
        <a href="<?php echo SITEURL; ?>admin/add-army-specific.php" class="btn-primary">Add a Specific Person</a>
