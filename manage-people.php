...
<div class="main-content">
    <div class="wrapper">
        ...
        <!-- Button to Add Army -->
        <a href="<?php echo SITEURL; ?>add-people.php" class="btn-primary">Add People</a>
                ...
                while ($row = mysqli_fetch_assoc($res))
                {
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo SITEURL;?>update-people.php?id=<?php echo $id; ?>" class="btn-secondary">Update</a>
                                <a href="<?php echo SITEURL;?>delete-people.php?id=<?php echo $id; ?>" class="btn-danger">Delete</a>
