...
<div class="main-content">
    <div class="wrapper">
        ...
        <a href="<?php echo SITEURL; ?>add-portal.php" class="btn-primary">Add Portal</a>
                ...
                while ($row = mysqli_fetch_assoc($res))
                {
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo SITEURL;?>delete-portal.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name; ?>" class="btn-danger">Delete</a>
