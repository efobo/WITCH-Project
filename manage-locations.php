...
<div class="main-content">
    <div class="wrapper">
        ...
        <!-- Button to Add Food -->
        <a href="<?php echo SITEURL; ?>add-location.php" class="btn-primary">Add Location</a>
                ...
                while ($row = mysqli_fetch_assoc($res))
                {
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo SITEURL;?>update-location.php?id=<?php echo $id; ?>" class="btn-secondary">Update</a>
                                <a href="<?php echo SITEURL;?>delete-location.php?id=<?php echo $id; ?>" class="btn-danger">Delete</a>
